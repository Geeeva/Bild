...
class Logo extends Component {
  ...
  TweenLite.lagSmoothing(0);
		...
		.to(logo, 1, {rotation: "+=360", scale: .9});


		setTimeout(function() {
		   	this.setState({allowedAnimation: true})
		}.bind(this), 9200);
	...
	render() {
		return (
			<div id="Logo-wrapper">
			 	<svg id="Logo" viewBox="0 0 85.8 86" className={(this.props.rotation === true && this.state.allowedAnimation === true ? "logo-rotation" : "")}>
					...
					<path className={"clover" + (this.props.rotation === true && this.state.allowedAnimation === true ? " black-fill" : "")} id="Right" fill="#CFD8DC" d="M44.9,43.2c0,0,23.3-23.2,32.6-21.7c8.8,0.2,12.1,36.9,2.4,39.1S44.9,43.2,44.9,43.2z"/>
					<path className={"clover" + (this.props.rotation === true && this.state.allowedAnimation ===  true? " black-fill" : "")} id="Top" fill="#CFD8DC" d="M43,41.2c0,0-21.7-24.7-19.6-33.9c0.7-8.8,37.6-9.8,39.2,0C64.2,17.1,43,41.2,43,41.2z"/>
				</svg>
			</div>
		)
	}
